    ...
    return (
        <header className='greeting'>
            ...
            <p className='greeting-description'>
                ...
                This application is built using <span>HTML</span>, <span>SCSS</span>, <span>React</span> and <a href='https://www.themoviedb.org/' className="greeting-description__api">TMDB API</a>
            </p>
